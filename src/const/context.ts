...
export const mediaBrowserConfigContext = createContext<MediaBrowserConfig>(uuid4());
...
export const activePlayerControllerContext = createContext<ActivePlayerController>(uuid4());
export const actionsControllerContext = createContext<ActionsController>(uuid4());
...
export const browserControllerContext = createContext<MediaBrowserController>(uuid4());
...
export const previousQueueItemContext = createContext<QueueItem | null>(uuid4());

export const mediaBrowserCardsContext = createContext<newMediaBrowserItemsConfig>(uuid4());
export const activeMediaBrowserCardsContext = createContext<MediaCardItem[]>(uuid4());
